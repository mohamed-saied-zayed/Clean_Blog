                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <?php endforeach;?>
                            <?php endif; ?>   
                            <form action="<?php echo BASE_URL."index.php?page=sign-up-action"; ?>"  method="POST" >
                                ...
                                <div class="form-floating">
                                    <input class="form-control" name ="password" type="tel" placeholder="Enter your password..." data-sb-validations="required" />
